...
public class ContactAdapter extends ArrayAdapter<Contact> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            TextView contactName = (TextView)
                    v.findViewById(R.id.textContactName);
            TextView contactNumber = (TextView)
                    v.findViewById(R.id.textPhoneNumber);
    ...
    public void deleteOption(int contactToDelete, Context context) {
